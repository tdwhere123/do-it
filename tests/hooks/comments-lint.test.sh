...
unset CLAUDE_PLUGIN_DATA CODEX_HOME KIMI_CODE_HOME KIMI_PLUGIN_ROOT CLAUDE_AGENT_CONTEXT CLAUDE_SUBAGENT CURSOR_SUBAGENT CURSOR_AGENT_CONTEXT CURSOR_PLUGIN_DATA OPENCODE_DATA
