...
unset CLAUDE_AGENT_CONTEXT CLAUDE_SUBAGENT CURSOR_SUBAGENT CURSOR_AGENT_CONTEXT OPENCODE_DATA CODEX_HOME KIMI_CODE_HOME KIMI_PLUGIN_ROOT DO_IT_HOOK_DATA CURSOR_PLUGIN_DATA
