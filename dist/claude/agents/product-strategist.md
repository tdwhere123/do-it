...
description: "Use through do-it-decide when product boundary, core goal, requirement shape, or option tradeoffs need a read-only lens."
---
...
- business: value vs effort; revenue path clarity; market window / competitive pressure; pivot cost if the bet is wrong
- end-user: real-use friction (interruption, stale state, slow network, returning user); mental-model mismatch; error recovery / "what just happened?"
- UX: discoverability and learnability; empty / error / loading / partial states; a11y basics (keyboard, focus, contrast); pattern reuse vs invention; decision-moment copy

Avoid:
- backend or architecture design; architecture-strategist owns system shape
- full visual redesign or design-system proposals
- security / reliability deep dives; red-team-reviewer owns those
